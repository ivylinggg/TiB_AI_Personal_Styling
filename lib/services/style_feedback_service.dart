...
class StyleFeedbackService {
  ...
  static Future<void> recordSavedLook({required List<String> itemIds, required String occasion}) => recordAction(action: 'saved', itemIds: itemIds, occasion: occasion, source: 'ai_outfit');
  static Future<void> recordWearAgain({required List<String> itemIds, required String occasion}) => recordAction(action: 'wear_again', itemIds: itemIds, occasion: occasion, source: 'saved_looks');
  static Future<void> recordRestyle({required List<String> itemIds, required String occasion}) => recordAction(action: 'restyle', itemIds: itemIds, occasion: occasion, source: 'ai_outfit');
  static Future<void> recordShoeChange({required List<String> itemIds, required String occasion}) => recordAction(action: 'change_shoes', itemIds: itemIds, occasion: occasion, source: 'ai_outfit');
