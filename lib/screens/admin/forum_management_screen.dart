...
class _ForumManagementScreenState extends State<ForumManagementScreen> {
  ...
  Future<bool> _addAdminReply(DocumentReference<Map<String, dynamic>> postRef, String text) async {
  ...
  Future<void> _deletePost(QueryDocumentSnapshot<Map<String, dynamic>> doc) async {
    ...
    try {
      ...
      final batch = FirebaseFirestore.instance.batch();
      for (final item in comments.docs) batch.delete(item.reference);
      for (final item in likes.docs) batch.delete(item.reference);
            ...
            Padding(
              ...
              child: Column(children: [
                ...
                SingleChildScrollView(
                  ...
                  child: Row(children: _filters.map((item) => Padding(
