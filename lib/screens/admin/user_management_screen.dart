      ...
      await Future.wait(
        result.imageUrls.map((url) async {
          try {
            ...
            // Storage cleanup is best-effort; Firestore deletion remains authoritative.
          }
        }),
      );
    }
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Wrap(
                          ...
                          runSpacing: 5,
                          children: [
                            _statusChip(role.toUpperCase(), AppColors.surfaceMuted, AppColors.primaryDark),
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text('${filteredUsers.length} ${filteredUsers.length == 1 ? 'user' : 'users'}', style: TextStyle(color: AppColors.textSecondary, fontWeight: FontWeight.w600)),
                  const Spacer(),
