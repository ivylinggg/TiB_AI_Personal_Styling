  ...
  Widget _buildStatsGrid() {
    return GridView.count(
      ...
      children: [
        ...
        _buildStatCard('Staff', totalStaff, Icons.badge_outlined, () => _goTo(6)),
        _buildStatCard('Active Staff', activeStaff, Icons.support_agent_outlined, () => _goTo(6)),
        _buildStatCard('Published Content', publishedContent, Icons.library_books_outlined, () => _goTo(3)),
        _buildStatCard('Waiting Consults', waitingConsultations, Icons.mark_chat_unread_outlined, () => _goTo(5)),
        _buildStatCard('Active Consults', activeConsultations, Icons.forum_outlined, () => _goTo(5)),
        _buildStatCard('Resolved Consults', resolvedConsultations, Icons.check_circle_outline, () => _goTo(5)),
        _buildStatCard('Online Consultants', onlineConsultants, Icons.wifi_tethering_rounded, () => _goTo(5)),
      ],
    );
  }
          ...
          children: [
            Row(
              children: [
                ...
                TextButton(onPressed: () => _goTo(5), child: const Text('Open')),
              ],
            ),
            const SizedBox(height: 14),
            Row(
      ...
      children: [
        ...
        Wrap(
          ...
          children: [
            ...
            _buildActionChip(Icons.support_agent_outlined, 'Consultations', () => _goTo(5)),
