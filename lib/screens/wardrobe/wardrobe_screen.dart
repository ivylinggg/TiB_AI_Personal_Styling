...
class _WardrobeScreenState extends State<WardrobeScreen>
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            icon: Icon(
              _showFavouritesOnly ? Icons.favorite_rounded : Icons.favorite_border_rounded,
          ...
          child: Row(
            ...
            children: [
              ...
              ConstrainedBox(
                ...
                child: Text(label, maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(fontSize: 10, fontWeight: FontWeight.w700, color: AppColors.primary)),
              ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 6),
                Text(_headlineFor(totalCount), style: const TextStyle(color: _text, fontSize: 26, fontWeight: FontWeight.w800, letterSpacing: -.4)),
                      ...
                      child: Material(
                        ...
                        child: IconButton(
                          ...
                          icon: AnimatedScale(
                            ...
                            curve: Curves.easeOut,
                            child: Icon(item.isFavourite ? Icons.favorite : Icons.favorite_border, color: item.isFavourite ? AppColors.premiumAccent : _brown, size: 19),
                          ),
                        ),
                      ),
                    ),
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        const SizedBox(width: 5),
                        Expanded(child: Text('${item.category} · ${item.colour}', maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(color: _muted, fontSize: 11.5))),
                      ],
                    ),
                  ],
                ),
        ...
        builder: (context, setSheetState) {
          Future<void> save() async {
            ...
            try {
              ...
              await FirestoreService.addWardrobeItem(WardrobeItem(
                id: '',
                userId: uid,
                imageUrl: imageUrl,
  ...
  Future<void> _confirmDelete(WardrobeItem item, String uid) async {
    ...
    try {
      ...
      if (!mounted) return;
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Could not remove this piece. Please try again.')));
    }
  }
                        ...
                        children: [
                          ...
                          Positioned(
                            ...
                            child: Material(
                              color: AppColors.background.withValues(alpha: .92),
                              shape: const CircleBorder(),
                              child: const Padding(padding: EdgeInsets.all(8), child: Icon(Icons.edit_outlined, size: 18, color: _brown)),
                            ),
                          ),
                        ],
                      ),
