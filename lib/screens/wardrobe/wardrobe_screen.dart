              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 12),
                    _dropdown('Category', category, _categoryOptions,
                        (v) => setSheetState(() => category = v)),
                    _dropdown('Colour', colour, _colourOptions,
                        (v) => setSheetState(() => colour = v)),
                    _dropdown('Style', style, _styleOptions,
                        (v) => setSheetState(() => style = v)),
                    _dropdown('Season', season, _seasonOptions,
                        (v) => setSheetState(() => season = v)),
                    const SizedBox(height: 4),
                    TextField(
                      controller: notesController,
