                        ...
                        SliverPadding(
                          ...
                          sliver: SliverGrid(
                            delegate: SliverChildBuilderDelegate(
                              (context, index) =>
                                  _buildItemCard(filtered[index], uid),
        ...
        child: Row(
          children: [
            Container(
              ...
              child: const Icon(Icons.checkroom_rounded, color: _brown),
            ),
        ...
        itemBuilder: (context, index) {
          ...
          return ChoiceChip(
            ...
            labelStyle: TextStyle(
              color: _category == value ? Colors.white : _text,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Start with a few pieces you already own. Your future outfit suggestions will feel much more like you.',
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: const InputDecoration(
                        labelText: 'Name',
                        hintText: 'e.g. Cream knit cardigan',
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  const Icon(Icons.checkroom_outlined, color: _brown),
              ...
              Text(
                '${item.category} · ${item.colour} · ${item.style}',
