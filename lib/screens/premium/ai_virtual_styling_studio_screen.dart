...
class _AIVirtualStylingStudioScreenState extends State<AIVirtualStylingStudioScreen> {
        ...
        child: ListView(
          ...
          children: [
            ...
            _actionCard(
              ...
              subtitle: ready ? 'Update your face, body photo or model details.' : 'Build your reusable face and body profile.',
            ...
            _actionCard(
              ...
              subtitle: 'Select your wardrobe and generate a try-on image with your TiB Model.',
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      ready ? 'Your model photos stay on this device. The same TiB Model is reused across your Premium styling experiences.' : 'Create your TiB Model first. Your photos stay on this device and become the foundation for your Premium styling experiences.',
                      style: const TextStyle(color: AppColors.textSecondary, fontSize: 10.5, height: 1.45),
                    ),
                  ),
                ],
              ),
      ...
      child: Row(
        children: [
          Container(
            ...
            child: photo != null && photo.existsSync() ? Image.file(photo, fit: BoxFit.cover) : const Icon(Icons.person_rounded, size: 48, color: AppColors.primary),
          ),
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Text(ready ? 'MODEL READY' : 'MODEL NOT SET', style: const TextStyle(color: AppColors.primaryDark, fontSize: 8, fontWeight: FontWeight.w900, letterSpacing: .9)),
                ),
        ...
        children: [
          ...
          if (ready) ...[
            ...
            Container(
              ...
              decoration: BoxDecoration(color: AppColors.primarySoft.withValues(alpha: .45), borderRadius: BorderRadius.circular(14)),
              child: const Row(children: [Icon(Icons.auto_awesome_rounded, size: 15, color: AppColors.primaryDark), SizedBox(width: 7), Expanded(child: Text('Your face shape and body shape are automatically used for personalised AI styling.', style: TextStyle(color: AppColors.primaryDark, fontSize: 9.5, height: 1.35)))]),
            ),
          ],
        ],
      ),
  ...
  Widget _valueBadge(String value, bool active) {
    return Container(
      padding: const EdgeInsets.symmetric(horizontal: 9, vertical: 5),
      decoration: BoxDecoration(color: active ? AppColors.primarySoft : AppColors.surfaceMuted, borderRadius: BorderRadius.circular(12)),
      child: Text(value, style: TextStyle(fontSize: 10, fontWeight: FontWeight.w900, color: active ? AppColors.primaryDark : AppColors.textMuted)),
    );
  }
  ...
  Widget _measurement(String label, double value, String unit) {
    ...
    return Expanded(
      child: Container(
        ...
        child: Column(children: [Text(label, style: const TextStyle(fontSize: 9, color: AppColors.textMuted, fontWeight: FontWeight.w700)), const SizedBox(height: 4), Text(text, style: const TextStyle(fontSize: 11, fontWeight: FontWeight.w900))]),
      ),
    );
  }
          ...
          child: Row(
            children: [
              Container(
                width: 46,
                height: 46,
                decoration: BoxDecoration(color: enabled ? AppColors.primarySoft : AppColors.surfaceMuted, shape: BoxShape.circle),
                child: Icon(icon, color: enabled ? AppColors.primaryDark : AppColors.textMuted, size: 21),
              ),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(enabled ? subtitle : 'Create your TiB Model first.', style: const TextStyle(color: AppColors.textSecondary, fontSize: 10.5, height: 1.35)),
                  ],
                ),
              ),
              const SizedBox(width: 7),
              Icon(enabled ? Icons.arrow_forward_ios_rounded : Icons.lock_outline_rounded, size: 15, color: enabled ? AppColors.primary : AppColors.textMuted),
            ],
          ),
        ),
      ),
