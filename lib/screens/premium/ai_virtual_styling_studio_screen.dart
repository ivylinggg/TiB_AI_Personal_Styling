...
class AIVirtualStylingStudioScreen extends StatefulWidget {
  ...
  @override
  State<AIVirtualStylingStudioScreen> createState() =>
      _AIVirtualStylingStudioScreenState();
}

class _AIVirtualStylingStudioScreenState
    extends State<AIVirtualStylingStudioScreen> {
        ...
        child: ListView(
          ...
          children: [
            ...
            _actionCard(
              ...
              subtitle:
                  'Preview your selected wardrobe pieces on your model.',
      ...
      child: Column(
        children: [
          ...
          _profileRow(
            ...
            'Full-body reference',
            model?.bodyPath != null ? 'Added' : 'Optional',
            model?.bodyPath != null,
          ),
          const Divider(height: 20),
          _profileRow(
