...
class _AIVirtualStylingStudioScreenState extends State<AIVirtualStylingStudioScreen> {
  ...
  void _openAiStylist(BuildContext context) {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => const AiStyleMeScreen()),
    );
  }
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: const TextStyle(fontSize: 24, height: 1.0, fontWeight: FontWeight.w900),
                ),
                const SizedBox(height: 8),
                Text(
                  ready ? 'Ready to style with your own wardrobe.' : 'Add your face once, then build looks around you.',
