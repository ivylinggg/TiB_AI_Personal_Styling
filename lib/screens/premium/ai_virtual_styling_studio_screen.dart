      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            _actionCard(context, icon: Icons.view_in_ar_rounded, title: 'Virtual Try-On Preview', subtitle: 'Preview your selected wardrobe pieces on your model.', onTap: () => _openTryOn(context), enabled: ready),
            const SizedBox(height: 18),
