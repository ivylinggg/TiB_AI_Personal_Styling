...
class _VirtualTryOnScreenState extends State<VirtualTryOnScreen> {
  ...
  void _toggle(WardrobeItem item) {
    ...
    setState(() {
      ...
      _generatedImageUrl = null; _requestId = null; _status = _selectedIds.isEmpty ? '' : '${_selectedIds.length} piece${_selectedIds.length == 1 ? '' : 's'} selected.';
    });
  }
