...
Create one photorealistic head-to-toe image of this same user wearing only the selected real wardrobe pieces. Preserve garment construction, colour, texture and details. Show the complete body whenever possible, including shoes when selected. Use a natural standing pose and realistic fabric fit.''';
  ...
  Widget _pill(String text, bool good) {
    return Container(
      ...
      children: [
        ...
        SizedBox(
          ...
          child: ListView.separated(
            ...
            itemBuilder: (_, index) {
              final value = _occasions[index];
              final selected = value == _occasion;
              return ChoiceChip(
                label: Text(value),
                selected: selected,
                onSelected: _busy
      ...
      children: [
        ...
        Expanded(
          child: FilledButton.icon(
            ...
            label: Text(_busy ? 'Creating…' : 'Generate Try-On'),
      ...
      children: [
        ...
        if (_wardrobe.isEmpty)
          Container(
            ...
            child: const Center(child: Text('Add clothes to My Wardrobe first.')),
          )
        else
          GridView.builder(
            shrinkWrap: true,
  ...
  Widget _selectedBar(List<WardrobeItem> items) {
    return Container(
        ...
        children: [
          const Padding(
            ...
            child: Row(
              children: [
                ...
                SizedBox(width: 7),
                Text(
                  'YOUR PERSONAL VIRTUAL YOU',
                  style: TextStyle(fontSize: 10, fontWeight: FontWeight.w800, letterSpacing: .8),
                ),
              ],
            ),
          ),
          ...
          if (_requestId != null)
            Padding(
              ...
              child: Text(
                'Reference: ${_requestId!.substring(0, _requestId!.length > 8 ? 8 : _requestId!.length)}',
  ...
  Widget _statusCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: _generatedImageUrl != null ? AppColors.primarySoft : Colors.white,
