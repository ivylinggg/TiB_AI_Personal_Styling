            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Text(ready ? 'TIΒ MODEL READY' : 'MODEL REQUIRED', style: TextStyle(color: ready ? AppColors.primaryDark : AppColors.textMuted, fontSize: 8, fontWeight: FontWeight.w900, letterSpacing: .9)),
                ),
      ...
      child: Column(
        ...
        children: [
          ...
          ClipRRect(
            ...
            child: Image.network(_generatedImageUrl!, width: double.infinity, fit: BoxFit.cover, errorBuilder: (context, error, stack) => Container(height: 300, alignment: Alignment.center, color: AppColors.surfaceMuted, child: const Text('The generated image could not be displayed.'))),
          ),
          const SizedBox(height: 12),
