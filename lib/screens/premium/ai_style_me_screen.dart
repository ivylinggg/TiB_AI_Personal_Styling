...
class _AiStyleMeScreenState extends State<AiStyleMeScreen> {
  ...
  Future<void> _styleMe() async {
    ...
    if (_analysis == null) {
      _show(
        'Complete Colour Analysis first so TiB can personalise the look.',
      );
      return;
    }
    ...
    if (result == null) {
      ...
      _show(
        'TiB could not reach the AI stylist right now. Try again in a moment.',
      );
      return;
    }
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: FilledButton.icon(
                    ...
                    label: Text(
                      _busy ? 'Styling you…' : 'Create My Look',
                    ),
                  ),
                ),
              ],
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (_look.isEmpty)
                    const Text(
                      'TiB returned an explanation but no complete wardrobe match was available.',
                    )
                  else
                    GridView.builder(
                      shrinkWrap: true,
