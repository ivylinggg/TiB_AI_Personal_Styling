...
class _SavedLooksScreenState extends State<SavedLooksScreen>
  ...
  Future<void> _deleteLook(String lookId) async {
    final uid = FirebaseAuth.instance.currentUser?.uid;
    if (uid == null || lookId.isEmpty) return;
  ...
  void _openLook(Map<String, dynamic> look) {
    ...
    final detailColumns = compact ? 2 : pieces.length.clamp(1, 4).toInt();
  ...
  Widget _missingPiecesCard() {
    return Container(
      ...
      child: const Row(
        children: [
          Icon(Icons.checkroom_outlined, color: AppColors.primary),
          SizedBox(width: 10),
          Expanded(
            child: Text(
                            ...
                            builder: (context, constraints) {
                              ...
                              return SliverGrid(
                                ...
                                gridDelegate:
                                  ...
                                  crossAxisSpacing: 12,
                                  mainAxisSpacing: 12,
                                  childAspectRatio: columns == 3 ? .78 : .82,
                                ),
                              );
                            },
                          ),
        ...
        children: [
          ...
          Text(
            _looks.isEmpty
                ...
                : '${_looks.length} saved ${_looks.length == 1 ? 'look' : 'looks'} in your personal collection.',
            style: const TextStyle(
              color: AppColors.textSecondary,
              fontSize: 12.5,
              height: 1.45,
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          const Text(
            'Save an outfit that feels like you and it will stay here for the next time you need it.',
            textAlign: TextAlign.center,
            style: TextStyle(
              color: AppColors.textSecondary,
              height: 1.45,
