...
class _StyleMeScreenState extends State<StyleMeScreen> {
  ...
  Future<void> _styleMe() async {
    ...
    if (prompt.isEmpty || _styling || _wardrobe.isEmpty) {
      return;
    }
    ...
    if (profile == null) {
      setState(() {
        _status =
            'Complete Colour Analysis first so your look can be colour-aware.';
        _aiResult = null;
        _localLook = const [];
      });
      return;
  ...
  List<WardrobeItem> _buildLocalLook(
    String prompt,
    ...
    int score(WardrobeItem item) {
      ...
      if (profile.colours.any(
        (c) =>
            c.toLowerCase().contains(colour) ||
            colour.contains(c.toLowerCase()),
      )) {
        value += 12;
      }
    ...
    if (shoes != null && !look.any((i) => i.id == shoes!.id)) {
      look.add(shoes);
    }
      ...
      body: _loading
          ...
          : _wardrobe.isEmpty
              ? EmptyState(
                  ...
                  description:
                      'Style Me only recommends pieces you actually own.',
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: FilledButton.icon(
                          ...
                          label: Text(
                            _styling ? 'Building your look…' : 'Style Me',
                          ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              const Icon(Icons.auto_awesome_rounded, color: AppColors.peach),
