          ...
          Container(
            ...
            child: const Row(
              ...
              children: [
                ...
                Expanded(
                  child: Text(
                    'Tell us what you need help with. Your message will be sent to our TiB consultancy team and a real consultant can reply here.',
                ...
                if (messages.isEmpty) {
                  return const Center(
                    child: Padding(
                      ...
                      child: Text('Your consultation is ready. Send your first question below.', textAlign: TextAlign.center, style: TextStyle(color: AppColors.textSecondary, height: 1.5)),
                    ),
                  );
                }
                    ...
                    return Align(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            if (consultant) ...[
                              Text(data['senderName'] as String? ?? 'TiB Consultant', style: const TextStyle(fontSize: 10, fontWeight: FontWeight.w800, color: AppColors.primary)),
                              const SizedBox(height: 3),
                            ],
                            Text(data['text'] as String? ?? '', style: TextStyle(fontSize: 12.5, height: 1.4, color: consultant ? AppColors.textPrimary : Colors.white)),
                          ],
                        ),
                      ),
                    );
