...
class DashboardDesignedScreen extends StatelessWidget {
  ...
  int _styleScore(ColourAnalysisResult? result) {
    final values = _scoreBreakdown(result).values;
    return values.fold<int>(0, (total, value) => total + value).clamp(0, 100);
  }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  const Expanded(child: Text('STYLE SCORE', style: TextStyle(color: AppColors.textMuted, fontSize: 9.5, fontWeight: FontWeight.w900, letterSpacing: .7))),
              ...
              Row(
                ...
                children: [
                  Text('$score', style: const TextStyle(fontSize: 34, fontWeight: FontWeight.w900, height: .95)),
                  const Padding(padding: EdgeInsets.only(left: 3, bottom: 3), child: Text('/100', style: TextStyle(color: AppColors.textMuted, fontSize: 11, fontWeight: FontWeight.w700))),
                  const Spacer(),
                  SizedBox(width: 78, height: 42, child: CustomPaint(painter: _ScorePainter(score / 100))),
                ],
              ),
                  ...
                  return Expanded(
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        child: Text('${entry.key[0]}  ${entry.value}', style: const TextStyle(fontSize: 9.5, fontWeight: FontWeight.w800)),
                      ),
                    ),
                  );
                }).toList(),
            ...
            children: [
              Row(
                children: [
                  ...
                  Text('$score/100', style: const TextStyle(color: AppColors.primaryDark, fontSize: 17, fontWeight: FontWeight.w900)),
                ],
              ),
              const SizedBox(height: 7),
              ...
              const SizedBox(height: 18),
              ...breakdown.entries.map<Widget>((entry) {
