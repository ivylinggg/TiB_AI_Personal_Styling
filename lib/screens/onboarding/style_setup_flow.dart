...
class _StyleSetupFlowState extends State<StyleSetupFlow> {
  ...
  static const _steps = [
    _SetupStep(
      ...
      subtitle: 'Start with your personal colour profile.',
    ...
    _SetupStep(
      ...
      subtitle: 'Choose the looks that naturally feel like you.',
    ...
    _SetupStep(
      ...
      subtitle: 'Add pieces TiB can actually style for you.',
      icon: Icons.checkroom_outlined,
      gradient: AppGradients.ai,
    ),
    _SetupStep(
      eyebrow: '04 · YOUR STYLIST',
      title: 'Meet your personal stylist.',
      subtitle: 'Use everything TiB has learned to create your next look.',
  ...
  Future<void> _continue() async {
    if (_step == 0) {
      ...
      await Navigator.push(
        context,
        MaterialPageRoute(builder: (_) => const StylePersonalityScreen()),
      );
    } else if (_step == 2) {
      await Navigator.push(
        context,
            ...
            Padding(
              ...
              child: SizedBox(
                ...
                child: FilledButton.icon(
                  ...
                  label: Text(
                    _step == _steps.length - 1 ? 'Meet TiB' : 'Continue',
                  ),
                ),
              ),
            ),
