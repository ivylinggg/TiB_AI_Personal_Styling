...
class StyleSetupFlow extends StatefulWidget {
  ...
  const StyleSetupFlow({super.key, this.initialStep = 0});
...
class _StyleSetupFlowState extends State<StyleSetupFlow> {
  ...
  static const _steps = [
    _SetupStep(eyebrow: '01 · COLOUR', title: 'Discover your colours.', subtitle: 'Start with your personal colour profile.', icon: Icons.palette_outlined, gradient: AppGradients.blush),
    _SetupStep(eyebrow: '02 · PERSONALITY', title: 'Find your style language.', subtitle: 'Choose the looks that naturally feel like you.', icon: Icons.auto_awesome_outlined, gradient: AppGradients.soft),
    _SetupStep(eyebrow: '03 · WARDROBE', title: 'Bring your wardrobe in.', subtitle: 'Add pieces TiB can actually style for you.', icon: Icons.checkroom_outlined, gradient: AppGradients.ai),
    _SetupStep(eyebrow: '04 · YOUR STYLIST', title: 'Meet your personal stylist.', subtitle: 'Use everything TiB has learned to create your next look.', icon: Icons.auto_awesome_rounded, gradient: AppGradients.primary),
  ];
        ...
        child: Column(
          children: [
                  ...
                  child: Column(children: [
                    Expanded(
                      child: Container(
                        ...
                        decoration: BoxDecoration(gradient: current.gradient, borderRadius: BorderRadius.circular(34)),
            ...
            Padding(
              ...
              child: SizedBox(width: double.infinity, child: FilledButton.icon(onPressed: _continue, icon: Icon(_step == _steps.length - 1 ? Icons.auto_awesome_rounded : Icons.arrow_forward_rounded), label: Text(_step == _steps.length - 1 ? 'Meet TiB' : 'Continue'))),
            ),
          ],
        ),
      ),
...
class _SetupStep {
  ...
  const _SetupStep({required this.eyebrow, required this.title, required this.subtitle, required this.icon, required this.gradient});
}
